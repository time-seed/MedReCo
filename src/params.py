...
class DataArguments:
    ...
    modality_sample_weights: Optional[str] = field(
        default=None,
        metadata={"help": "Per-modality sampling weights as 'us:w1,ct:w2,mri:w3,cxr:w4'. "
                          "If not set, each modality is sampled proportionally to its data count."}
    )