...
from src.model.modeling_qwen2_5_vl import Qwen2_5_VLForConditionalGeneration
...
from src.model.processing_qwen2_5_vl import Qwen2_5_VLProcessor
local_rank = None
...
def train():
    ...
    if "Qwen2.5" in model_args.model_id:
        # TODO: 这里完全可以先加载，然后替换visual之后重新保存，就可以自动实现想要的效果
