...
if __name__ == "__main__":
    # Configuration
    JSONL_PATH = "/mnt/petrelfs/zhangtengfei/RadIR/dataset/CT_RATE/test_replaced.jsonl"  # TODO: 修改为你的jsonl文件路径
    ...
    OUTPUT_IMG_EMBEDS = "/mnt/petrelfs/zhangtengfei/RadIR/baseline/stage1/CT_img_embeds_test.pt"  # 输出图像embeddings的路径
    OUTPUT_TEXT_EMBEDS = "/mnt/petrelfs/zhangtengfei/RadIR/baseline/stage1/CT_text_embeds_test.pt"  # 输出文本embeddings的路径
